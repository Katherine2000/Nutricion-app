<?php
    ...
    if(isset($_POST['btncontrasena'])) {
        ...
        $sql = "UPDATE USUARIO SET contraseña= '$contrasena' WHERE usuario.cedula=1234189690";
...
<head>
	...
	<title>ConfiguracionUsuarioAdministrador</title>
	...
	<div id="root">
		<div class="SnackbarContainer">
			<div class="topbar_root__3LZWV">
				...
				<a class="topbar_backButton__M86qn" href="MenuAdministrativo.php">
...
<path fill="currentColor" d="M11.074 7.488L4.92 13.642l-.364 1.802 1.803-.363 6.154-6.154-1.439-1.439zm1.414-1.414l1.44 1.439 1.244-1.244-1.44-1.44-1.244 1.245zM2 18l1.08-5.345L13.732 2.001 18 6.27 7.346 16.922 2 18z"></path>
	...
	<font style="vertical-align: inherit;">Administrador</font></font></h1><a class="Link-module_link__zhb0A ProfileAvatar_logoutLink__2Cnna" href="index.php">
	<font style="vertical-align: inherit;">
		<font style="vertical-align: inherit;">
...
<form  method="post" action="ConfiguracionUsuarioAdmi.php">
...
<div class="Input-module_inputWrapper__15iRB">
			...
			<div class="Input-module_inputFieldWrapper__2w64c">
				<input  type="text" name="VPrimerApellido" class="Input-module_input__3MBkT" value="garces">

				<input  type="text" name="VSegundoApellido" class="Input-module_input__3MBkT" value="castañeda">
			</div>
		</div>
	</div>
</div>
...
<div class="profileRow_root__bv8R8">
	...
	<div class="profileRow_content__1DxAY">
		...
		<div class="Input-module_inputWrapper__15iRB profileGeneralFirstNameInput">
			...
			<div class="Input-module_inputFieldWrapper__2w64c">
				<input  type="text" name="VTelefono" class="Input-module_input__3MBkT Input-module_inputRightElement__2dLA3" value="3165689">
			</div>
		</div>
	</div>
...
<div class="profileRow_root__bv8R8">
	<p class="Typography-module_typography__1aUok Typography-module_bodyDefault__H2nhY Typography-module_fontWeightBold__PPKYR profileRow_label__2b9hr useStyles-module_margin-bottom-zero__19osT useStyles-module_margin-zero__2pH6A useStyles-module_padding-zero__2HMDO">
		<font style="vertical-align: inherit;">
			<font style="vertical-align: inherit;">Contraseña
			</font>

			<div class="Input-module_inputFieldWrapper__2w64c">
				<input id="contrasena" type="text" name="contrasena" class="Input-module_input__3MBkT Input-module_inputRightElement__2dLA3" value=" ">
			</div>

		</font></p>

	<div class="profileRow_content__1DxAY">
			<button name="btncontrasena" class="Button-module_button__8UevY Button-module_primaryButton__2bBcI profileGeneralPasswordButton">
